...
import 'package:speech_therapy/controllers/animal_am_controller.dart';
import 'package:speech_therapy/controllers/animal_en_controller.dart';
...
class _AnimalPageState extends State<animal> {
  var Height, Width;
  ...
  final List<String> imageData = [
    ...
    "images/animal/donkey.png",
    "images/animal/goat.png",
    "images/animal/hen.png",
    "images/animal/rat.png",
  ...
  void _playAudio(String assetPath) async {
    ...
    loggingUtil.logScreenUsage(feature, Duration(seconds: 1), 'Animal Categories');
  }
  ...
  Widget build(BuildContext context) {
    ...
    final List<String> titles = isEnglish
        ? [
            ...
            translation(context).cow,
            translation(context).dog,
            translation(context).donkey,
            translation(context).goat,
            translation(context).hen,
            translation(context).rat,
            translation(context).sheep,
          ]
        : [
            "ድመት",
            "ላም",
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          Text(
                            isEnglish ? translation(context).animals : "እንስሳ",
                            style: TextStyle(
                              fontSize: 25,
                              color: Colors.white,
                    ...
                    itemBuilder: (context, index) {
                      return InkWell(
                        onTap: () {
                          _playAudio(
                            isEnglish
                                ? animalEnList[index].audio
                                : animalAmList[index].audio,
                          );
